...
class AboutDictionaries(Koan):
    ...
    def test_dictionary_keys_and_values(self):
        ...
        self.assertTrue('one' in babel_fish.keys())
        self.assertFalse('two' in babel_fish.values())
        self.assertFalse('uno' in babel_fish.keys())
        self.assertTrue('dos' in babel_fish.values())
